...
const initialMintState = {
  loading: false,
  status: `Mint your ${contract.name} and Staking menu  will be opened after all have sold`,
  amount: 1,
  supply: "0",
  cost: "0",
};
    ...
    <div className="page">
      <div className="card">
        ...
        <a
          ...
          className="_90"
          target="_blank"
          href="https://polygonscan.com/address/0x6c529ba975f1aeca9d8234935a928e34e7852a1d"
        >
          View Contract
        </a>
        <a
          ...
          className="_90"
          target="_blank"
          href="https://opensea.io/collection/the-ember-jacket"
        >
          View Opensea
        </a>
      </div>
